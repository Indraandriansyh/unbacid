      ...
      >
        <div className="h-full flex flex-col">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            >
              <Users2 className={cn("w-5 h-5 shrink-0", activeMenu === "pendaftar" ? "text-white" : "group-hover:text-emerald-500")} />
              {showSidebarLabels ? <span className="font-semibold flex-1 text-left">Data Pendaftar</span> : null}
              {showSidebarLabels && activeMenu === "pendaftar" ? <ChevronRight className="ml-auto w-4 h-4" /> : null}
            </button>
          </nav>
